		...
		<div class="container">
			<div class="w3_footer_grids">
				...
				<div class="col-md-3 w3_footer_grid">
					<h3>Information</h3>
					<ul class="info"> 
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="aboutus.php">About Us</a></li>
				...
				<div class="col-md-3 w3_footer_grid">
					...
					<ul class="info"> 
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="../seller/regis_seller.php">Want to Become a Seller?</a></li>
						<!-- <li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="checkout.php">My Cart</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="login.php">Login</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="registered.php">Create Account</a></li> -->
					</ul>
