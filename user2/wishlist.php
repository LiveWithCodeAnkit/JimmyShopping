...
<ul id="demo1">
			...
			<li>
				<img src="images/22.jpg" alt="" />
				  <div class="slide-desc">
					<h3>Whole Lots Products Are Now Online With Us</h3>
				</div>
			</li>
				...
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					...
					<div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active" id="expeditions" aria-labelledby="expeditions-tab">
							...
							<?php
                                $w=mysqli_query($conn,"select * from tbl_wishlist where user_id=$uid");
                                $pres=mysqli_num_rows($w);
                                if($pres>0)
                                {
                                    while($wrow=mysqli_fetch_array($w))
                                    {
                                        $pid=$wrow['product_id'];
													...
													<div class="snipcart-item block" >
														...
														<div class="snipcart-details">
															<form action="#" method="post">																
                                                                    ...
                                                                    <a href="wdel.php?wid=<?php echo $wrow['wishlist_id'];?>" onclick='return checkremove()' style="padding: 10px;" class="btn btn-danger">X</a>
															</form>
														</div>
													</div>
												</figure>
                            ...
                            echo '<div align=center><h4 style="padding: 50px;">NOTHING IN YOUR WISHLIST😑.</div>';
                        }
							?>
